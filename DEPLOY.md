...
- **KOSPI·KOSDAQ 모두 조회된다** (2026-07 KOSDAQ 일별매매정보 API 승인 완료). KONEX는
  아직 미승인일 수 있는데, 미승인 시장은 자동으로 건너뛰며 openapi.krx.co.kr 에서 해당
  일별매매정보 API를 추가 신청하면 코드 변경 없이 바로 동작한다.
